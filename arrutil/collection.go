...
func StringEqualsComparer(a, b string) int { _ = "STUB: not implemented"; return 0 }

// ValueEqualsComparer Comparer for comdef.Compared type. It will compare by their value.
//
// returns: 0 if equal, -1 if a != b
func ValueEqualsComparer[T comdef.Compared](a, b T) int { _ = "STUB: not implemented"; return 0 }

// ReflectEqualsComparer Comparer for struct ptr. It will compare by reflect.Value
//
// returns: 0 if equal, -1 if a != b
func ReflectEqualsComparer[T any](a, b T) int { _ = "STUB: not implemented"; return 0 }
...
func ElemTypeEqualsComparer[T any](a, b T) int { _ = "STUB: not implemented"; return 0 }
...
func CloneSlice[T any](data []T) []T { _ = "STUB: not implemented"; return nil }

// Diff Produces the set difference of two slice according to a comparer function. alias of Differences
func Diff[T any](first, second []T, fn Comparer[T]) []T { _ = "STUB: not implemented"; return nil }
...
func Excepts[T any](first, second []T, fn Comparer[T]) []T { _ = "STUB: not implemented"; return nil }
...
func Union[T any](first, second []T, fn Comparer[T]) []T { _ = "STUB: not implemented"; return nil }
...
//		return s != "c"
//	})
func TakeWhile[T any](data []T, fn Predicate[T]) []T { _ = "STUB: not implemented"; return nil }
...
//		return s == "c"
//	})
func ExceptWhile[T any](data []T, fn Predicate[T]) []T { _ = "STUB: not implemented"; return nil }
